        ...
        <div className={styles.wrapper}>
            <section className={styles.acercade}>
                <div className={styles.contenedor}>
                    ...
                    <hr />
                    <p className={styles.parrafo}>Desde su apertura, Restaurantes NTN fue reconocido por la calidad de sus platos y precios altamente competitivos.<br /><br />
            ...
            <section className={styles.acercaUs}>
                ...
                <div className={styles.contenedor}>
                    <h2 className={styles.sobrenosotros}>Welcomeg</h2>
                    <hr />
                    ...
                    Nuestro compromiso es suplir todas tus expectativas y hacer que en tu visita vivas la mejor experiencia.<br/><br/>
